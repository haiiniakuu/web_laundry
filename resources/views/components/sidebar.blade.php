    ...
    <div :class="sidebarToggle ? 'justify-center' : 'justify-between'"
        ...
        <a href="{{ route('dashboard') }}">
            ...
            <img class="logo-icon" :class="sidebarToggle ? 'lg:block' : 'hidden'"
                src="{{ asset('compressed/icon.svg') }}" alt="Logo" />
        </a>
    </div>
    <!-- SIDEBAR HEADER -->
            ...
            <div>
                <h3 class="mb-4 text-xs uppercase leading-[20px] text-gray-400">
                    ...
                    <svg :class="sidebarToggle ? 'lg:block hidden' : 'hidden'"
                        ...
                        <path fill-rule="evenodd" clip-rule="evenodd"
                            d="M6 10.25a1.75 1.75 0 113.5 0v.01a1.75 1.75 0 11-3.5 0v-.01zm12 0a1.75 1.75 0 113.5 0v.01a1.75 1.75 0 11-3.5 0v-.01zM13.75 12a1.75 1.75 0 11-3.5 0v-.01a1.75 1.75 0 113.5 0V12z"
                            fill="currentColor" />
                    </svg>
                </h3>
                ...
                <ul class="flex flex-col gap-4 mb-6">
                    ...
                    @if (auth()->user()->id_level == 1 || auth()->user()->id_level == 2)
                        <li>
                            <a href="#"
                                @click.prevent="selected = (selected === 'DataMaster' ? '' : 'DataMaster')"
                                class="menu-item group"
                                :class="(selected === 'DataMaster') || (['customers', 'users', 'services'].includes(page)) ?
                                'menu-item-active' : 'menu-item-inactive'">
                                <svg :class="(selected === 'DataMaster') || (['customers', 'users', 'services'].includes(page)) ?
                                'menu-item-icon-active' : 'menu-item-icon-inactive'"
                                    width="24" height="24" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd" clip-rule="evenodd"
                                        d="M5.5 3.25C4.26 3.25 3.25 4.26 3.25 5.5v13c0 1.24 1.01 2.25 2.25 2.25h13c1.24 0 2.25-1.01 2.25-2.25v-13C20.75 4.26 19.74 3.25 18.5 3.25h-13zM4.75 5.5A.75.75 0 015.5 4.75h13a.75.75 0 01.75.75v13a.75.75 0 01-.75.75h-13a.75.75 0 01-.75-.75v-13zM6.25 9.714c0-.414.336-.75.75-.75h10a.75.75 0 110 1.5H7a.75.75 0 01-.75-.75zM6.25 14.286c0-.414.336-.75.75-.75h10a.75.75 0 110 1.5H7a.75.75 0 01-.75-.75z"
                                        fill="currentColor" />
                                </svg>

                                <span class="menu-item-text" :class="sidebarToggle ? 'lg:hidden' : ''">Data
                                    Master</span>
                                <svg class="menu-item-arrow absolute right-2.5 top-1/2 -translate-y-1/2 stroke-current"
                                    :class="[(selected === 'DataMaster') ? 'menu-item-arrow-active' :
                    ...
                    <div class="overflow-hidden transform translate"
                        ...
                        <ul :class="sidebarToggle ? 'lg:hidden' : 'flex'"
                            ...
                            @if (auth()->user()->id_level == 1)
                                <li>
                                    <a href="{{ route('customers.index') }}" class="menu-dropdown-item group"
                                        :class="page === 'customers' ? 'menu-dropdown-item-active' :
                                            'menu-dropdown-item-inactive'">Customers</a>
                                </li>
                                <li>
                                    <a href="{{ route('users.index') }}" class="menu-dropdown-item group"
                                        :class="page === 'users' ? 'menu-dropdown-item-active' :
                                            'menu-dropdown-item-inactive'">Users</a>
                                </li>
                                <li>
                                    <a href="{{ route('type_of_services.index') }}" class="menu-dropdown-item group"
                                        :class="page === 'services' ? 'menu-dropdown-item-active' :
                                            'menu-dropdown-item-inactive'">Services</a>
                                </li>
                    ...
                    <ul class="flex flex-col gap-4 mb-6">
                        ...
                        <li>
                            <a href="{{ route('orders.index') }}" class="menu-item group"
                                ...
                                <svg :class="page === 'orders' ? 'menu-item-icon-active' : 'menu-item-icon-inactive'"
                                    width="24" height="24" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd" clip-rule="evenodd"
            ...
            @if (auth()->user()->id_level == 1 || auth()->user()->id_level == 3)
                <div>
                    ...
                    <ul class="flex flex-col gap-4 mb-6">
                        <!-- reports -->
                        <li>
                            <a href="{{ route('reports.index') }}" class="menu-item group"
                                :class="page === 'reports' ? 'menu-item-active' : 'menu-item-inactive'">

                                <svg :class="page === 'reports' ? 'menu-item-icon-active' : 'menu-item-icon-inactive'"
                                    width="24" height="24" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd" clip-rule="evenodd"
