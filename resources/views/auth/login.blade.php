            ...
            <div class="flex flex-col flex-1 w-full lg:w-1/2">
                ...
                <div class="flex flex-col justify-center flex-1 w-full max-w-md mx-auto">
                    <div>
                        ...
                        <div>
                            <!-- ALERT ERROR -->
                            <div x-data="{ showAlert: {{ $errors->has('email') ? 'true' : 'false' }} }" x-show="showAlert" x-transition
                                class="mb-4 p-4 rounded-lg  text-error-700 border border-red-200">
                                {{ $errors->first('email') }}
                            </div>
                            ...
                            <div class="fixed z-50 hidden bottom-6 right-6 sm:block">
                                <button
                                    ...
                                    <svg class="fill-current dark:hidden" width="20" height="20"
                                        viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path
