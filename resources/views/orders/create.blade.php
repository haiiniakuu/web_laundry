...
<x-partials.page-header title="Tambah Orders" :breadcrumbs="[
   ...
   <div class="flex flex-wrap">
    ...
    <div class="w-full lg:w-1/2  p-4">
        ...
        {{-- <x-form.text-area name="notes" label="Catatan" x-model="notes" /> --}}
    </div>
   </div>
    ...
    <div class="px-4 mt-4 flex gap-2">
      <button type="submit" class="px-4 py-2  bg-brand-500 rounded-lg text-white  dark:text-white rounded">Simpan</button>
    </div>
  </form>
