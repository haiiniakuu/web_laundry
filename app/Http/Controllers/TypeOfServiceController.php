...
class TypeOfServiceController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('type_of_services.index')->with('success', 'Service Berhasil Ditambahkan');
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        return redirect()->route('type_of_services.index')->with('success', 'Service Berhasil Diubah');
    }
    ...
    public function destroy(string $id)
    {
        $service = TypeOfService::find($id);
        $service->delete();
        return redirect()->route('type_of_services.index')->with('success', 'Service Berhasil Dihapus');
    }
}
